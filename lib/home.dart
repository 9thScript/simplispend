...
class _HomePageState extends State<HomePage> {
  ...
  // Fetch the Firebase user
  User? user = FirebaseAuth.instance.currentUser;

  void initState() {
    super.initState();
    // Optionally you can check for user login here or in AppState
    if (user != null) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            // Pass the user's display name to the Header widget
            Header(
...
class Header extends StatelessWidget {
  ...
  const Header({super.key, required this.rank, required String userName});
  ...
  Widget build(BuildContext context) {
    ...
    // Safely access the user and displayName using null checks
    final userName = user?.displayName ??
        'Guest'; // Fallback to 'Guest' if user or displayName is null
